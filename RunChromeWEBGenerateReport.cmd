REM call npx wdio run .\config\wdio.chromium.conf.js --spec ..\test\specs\testPO.js
REM | tee .\report\%consoleLogReportFolder%\consoleLog.txt

@echo off

setlocal

REM echo Checking hanged Node.exe
REM call .\killNode.cmd
REM call killHangedPort.cmd
...
call npx wdio run .\config\wdio.chromium.conf.js | tee .\report\%consoleLogReportFolder%\consoleLog.txt
